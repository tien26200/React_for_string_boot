                        ...
                        <tbody>
                            {
                                this.state.employees.map(
                                    ...
                                    <tr key = {employee.id}>
                                        ...
                                        <td>
                                            <button className="btn btn-warning"  onClick={() => this.editProducts(employee.id)}> Update</button>
                                            <button className="btn btn-danger"  onClick={() => this.deleteProducts(employee.id)} style={{marginLeft: "8px"}}> Delete</button>
                                            <button className="btn btn-info"  onClick={() => this.viewProducts(employee.id)} style={{marginLeft: "8px"}}> Detail</button>
                                        </td> 
                                    </tr>
                                )
                            }
